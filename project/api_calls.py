...
def api_call():
    ...
    for uni in universities:
        university = create_unique(University , name=uni, num_undergrads=universities[uni]['undergrad_population'], cost_to_attend=abs(universities[uni]['cost_to_attend']), grad_rate=universities[uni]['grad_rate'], public_or_private=universities[uni]['public_or_private'])
    ...
    for city in cities:
        ...
        cur_city = create_unique(City, name=city, population=cities[city]['population'], avg_tuition=abs(cities[city]['average_tuition']), top_university=top_university[0], top_major=top_major[0], top_ethnicity=top_ethnicity[0])
        for uni in uni_objs:
            if universities[uni]['city'] == city:
