...
class Tests(TestCase):
    ...
    def test_update(self):
        ...
        num_students = DB.session.query(MAJORTOUNIVERSITY).filter(MAJORTOUNIVERSITY.c.university_id==university.id_num and MAJORTOUNIVERSITY.c.major_id==m.id_num).first().num_students
